...
@interface USCircleListTableCellView()
...
@end
@implementation USCircleListTableCellView
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier dataDic:(NSDictionary *)dataDic customerId:(NSString *)coustomerId tableview:(UITableView *)tablview navController:(UINavigationController *)navController{
    ...
    @try {
       ...
       // UIImageView *newsImage = [[UIImageView alloc]initWithFrame:CGRectMake(_contentLB.x,  _headerImageView.y+_headerImageView.height + kMargin, kCircleSize, kCircleSize)];
        ...
        _imagesView =[[USCircleImageView alloc]initWithFrame:CGRectMake(_contentLB.x, _headerImageView.y+_headerImageView.height + kMargin, kCircleSize, kCircleSize)  imageUrls:@[HYWebDataPath(_dataDic[@"pic_path"])] placehlderImageName:@"circle_default" options:-1];
