...
@interface USMyInvitListViewController ()
...
@implementation USMyInvitListViewController
...
- (void)viewDidLoad {
    ...
    _msg = @"正在加载...";
    _url = @"wangkaInviterClientcontroller/getMyPublishInviterList.action";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    USMyInvitView *view = [[USMyInvitView alloc]initWithDic:_dataDicList[indexPath.row] superVC:self];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    USInvitRecordViewController *recordVC = [[USInvitRecordViewController alloc]init];
    recordVC.inviter_id = _dataDicList[indexPath.row][@"id"];
